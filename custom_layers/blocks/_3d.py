...
def basic_3d(filters, stage=0, block=0, kernel_size=3, numerical_name=False, stride=None):
    ...
    def f(x):
        ...
        y = keras.layers.BatchNormalization(epsilon=1.1e-5, axis=axis, name="bn{}{}_branch2a".format(stage_char, block_char))(y)
        ...
        y = keras.layers.BatchNormalization(epsilon=1.1e-5, axis=axis, name="bn{}{}_branch2b".format(stage_char, block_char))(y)
        ...
        if block == 0:
            ...
            shortcut = keras.layers.BatchNormalization(epsilon=1.1e-5, axis=axis, name="bn{}{}_branch1".format(stage_char, block_char))(shortcut)
        else:
            shortcut = x
...
def bottleneck_3d(filters, stage=0, block=0, kernel_size=3, numerical_name=False, stride=None, freeze_bn=False):
    ...
    def f(x):
        ...
        y = keras.layers.BatchNormalization(epsilon=1.1e-5, axis=axis, name="bn{}{}_branch2c".format(stage_char, block_char))(y)
